...
const VisitorDetailScreen = () => {
  ...
  const theme = getMajorTheme(majorName); // 👈 Lấy theme theo từng ngành
  ...
  // Lấy màu sắc từ theme - dùng trực tiếp theme, không cần gán lại biến khác
  // Nếu theme null thì dùng fallback màu xanh dương
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <div
            className={`animate-spin rounded-full h-12 w-12 border-b-2 mx-auto ${theme?.textColor || "text-blue-600"}`}
          />
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between h-16 mt-2">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`px-4 py-1.5 border rounded-md text-sm transition ${theme?.textColor || "text-blue-600"} ${theme?.borderColor || "border-blue-600"} hover:text-white ${theme?.bgColor || "bg-blue-600"}`}
              >
                Đăng nhập
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`px-5 py-3 font-medium text-sm transition ${
                      activeTab === tab.id
                        ? `${theme?.tabActive || "text-blue-600"} border-b-2 ${theme?.border || "border-blue-200"}`
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {product.technologies.map((tech, i) => (
                        <span
                          key={i}
                          className={`px-3 py-1 text-gray-700 text-sm rounded-full ${theme?.light || "bg-blue-50"}`}
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    <div className="space-y-2">
                      {product.github && (
                        <a
                          ...
                          className={`flex items-center gap-2 ${theme?.textColor || "text-blue-600"} hover:underline`}
                        >
                          📦 GitHub Repository
                        </a>
                      )}
                ...
                {activeTab === "team" && (
                  <div>
                    <div className="mb-6">
                      ...
                      <div
                        className={`flex items-center gap-4 p-4 rounded-lg ${theme?.light || "bg-blue-50"}`}
                      >
                        <div
                          className={`w-12 h-12 rounded-full text-white flex items-center justify-center text-lg font-bold ${theme?.buttonBg?.split(" ")[0] || "bg-blue-600"}`}
                        >
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex flex-wrap gap-3">
                            {product.collaborators.map((collab, i) => (
                              <div
                                key={i}
                                className={`flex items-center gap-2 p-2 rounded-lg ${theme?.light || "bg-blue-50"}`}
                              >
                                <div
                                  className={`w-8 h-8 rounded-full text-white flex items-center justify-center text-xs font-bold ${theme?.buttonBg?.split(" ")[0] || "bg-blue-600"}`}
                                >
                                  {collab.charAt(0)}
                                </div>
                    ...
                    <div>
                      ...
                      <div
                        className={`p-4 rounded-lg ${theme?.light || "bg-blue-50"}`}
                      >
                    ...
                    {product.feedback.map((fb, i) => (
                      ...
                      >
                        <div className="flex items-center gap-3 mb-2">
                          <div
                            className={`w-10 h-10 rounded-full text-white flex items-center justify-center text-sm font-bold ${theme?.buttonBg?.split(" ")[0] || "bg-blue-600"}`}
                          >
                            {fb.name.charAt(0)}
                          </div>
                          <div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
                ...
                <div className="space-y-3 border-t border-gray-100 pt-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span
                      className={`font-medium ${theme?.textColor || "text-blue-600"}`}
                    >
                      {product.major}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span
                      className={`flex items-center gap-1 font-medium ${theme?.textColor || "text-blue-600"}`}
                    >
                ...
                <div className="flex gap-3 mt-5">
                  <button
                    className={`flex-1 px-4 py-2 text-white rounded-md text-sm font-medium transition ${theme?.buttonBg || "bg-blue-600 hover:bg-blue-700"}`}
                  >
                    🔗 Chia sẻ
                  </button>
                </div>
              ...
              {/* Stats Card */}
              <div
                className={`bg-gradient-to-r ${theme?.gradient || "from-blue-600 to-indigo-600"} text-white rounded-xl p-5`}
              >
              ...
              {relatedProducts.map((item) => (
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <p
                      className={`text-xs mt-1 ${theme?.textColor || "text-blue-600"}`}
                    >
                      {item.major}
                    </p>
                  </div>
      ...
      {/* Footer */}
      <footer
        className={`bg-gradient-to-r ${theme?.gradient || "from-blue-600 to-indigo-600"} text-white mt-12 py-6`}
      >
