...
const VisitorScreen = () => {
  ...
  const products = [
    {
      ...
      description:
        "Ứng dụng quản lý công việc theo phương pháp Kanban, hỗ trợ team làm việc hiệu quả. Xây dựng bằng React và Node.js.",
      thumbnail:
    ...
    },
    {
      ...
      description:
        "Game Flappy Bird được viết lại bằng Python với Pygame, có thêm tính năng lưu điểm cao.",
      thumbnail:
    ...
    },
    {
      ...
      description:
        "Hệ thống giám sát nhiệt độ, độ ẩm và điều khiển thiết bị từ xa qua web.",
      thumbnail:
    ...
    },
    {
      ...
      description:
        "App học tiếng Anh với AI, đề xuất lộ trình học cá nhân hóa.",
      thumbnail:
    ...
    },
    {
      ...
      description:
        "Dashboard phân tích dữ liệu bán hàng với biểu đồ tương tác.",
      thumbnail:
    ...
    },
    {
      ...
      description:
        "Nền tảng quản lý học tập cho sinh viên với lịch học, bài tập và điểm số.",
      thumbnail:
  ...
  const filteredProducts = products.filter((product) => {
    const matchMajor =
      selectedMajor === "all" || product.major === selectedMajor;
    ...
    const matchSearch =
      ...
      product.studentName.toLowerCase().includes(keyword);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <Link
            to="/login"
            className="px-5 py-2.5 bg-white text-blue-700 font-semibold rounded-xl shadow-md hover:bg-blue-50 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
          >
            Đăng nhập
          </Link>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mt-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button className="px-3 py-1.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition">
                Mới nhất
              </button>
              <button className="px-3 py-1.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 transition">
                Xem nhiều
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-gray-100">
                ...
                <div className="absolute top-3 right-3">
                  <span className="px-2 py-1 bg-blue-600 text-white text-xs font-medium rounded-full shadow">
                    {product.year}
                  </span>
                </div>
              </div>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold shadow-sm">
