  ...
  const myProducts = [
    {
      ...
      description:
        "Ứng dụng quản lý công việc theo phương pháp Kanban, hỗ trợ team làm việc hiệu quả.",
      thumbnail:
    ...
    },
    {
      ...
      likes: 0,
      feedback:
        "Cần bổ sung tài liệu hướng dẫn chi tiết hơn và video demo sản phẩm.",
    },
  ];
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex justify-end">
                  <button
                    onClick={() =>
                      handleClickViewDetailById(product.product_id)
                    }
